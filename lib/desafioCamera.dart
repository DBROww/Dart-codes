...
class _HomePageState extends State<HomePage> {
  ...
  final List<Map<String, dynamic>> tarefas = [
    {"titulo": "Estudar Matemática", "feita": false, "foto": null},
    {"titulo": "Resumo de Química", "feita": true, "foto": null},
    {"titulo": "Exercícios de Português", "feita": false, "foto": null},
  ];
          ...
          return AlertDialog(
            ...
            content: Column(
              ...
              children: [
                ...
                if (fotoNovaTarefa != null) const SizedBox(height: 10),
  ...
  @override
  Widget build(BuildContext context) {
    int concluidas = tarefas.where((e) => e["feita"] == true).length;
                      ...
                      children: [
                        ListTile(
                          ...
                          title: Text(
                            ...
                            style: TextStyle(
                              decoration: tarefas[index]["feita"]
